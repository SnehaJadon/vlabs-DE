...
const Steps = {
  ...
  steps: [
    ...
    () => {
      ...
      const frames = [
        ...
        ()=>{
          ...
          //85, 15, 390
          Util.setCC("This is the place where we will conduct the survey.").onend(()=>{
        ...
        () => {
          ...
          const displayFrames = () => {
            function frame0() {
              Util.setCC("Click on application 'Emlid'.");
              let toShow = Src.base_setup_phone_display_1;
    ...
    () => {
      ...
      const frames = [
        ...
        ()=>{
          ...
          //85, 15, 390
          Util.setCC("This is another place from where we are taking the coordinates of GCP.").onend(()=>{
    ...
    () => {
      Scenes.StepProcess.start();
      Scenes.experimentHeading("Preparing the Drone and calibrate it.");
      Util.setCC("...");
      let mapStyle = {
        borderRadius: "15px",
        border: "3px solid black",
      ...
      const frames = [
        ...
        () => {
          ...
          Util.setCC("This is the place from where our drone takes off for the survey.").onend(()=>{
            Scenes.stepModal({
              title: "Steps:",
              description: "1. Open the Drone box. <br> 2. Bring all the components outside from the box. <br> 3. Calibrate the drone."
            }, ()=>{
      ...
      const frames = [
        ...
        () => {
          ...
          const displayFrames = () => {
            ...
            function frame3() {
              Util.setCC("Click on the highlighted area.");
